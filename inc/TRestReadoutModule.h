...
class TRestReadoutModule : public TObject {
   private:
    ...
    TString fModuleName;  ///< The assigned module name. i.e, microbulk, thermalbounding
                          ///< Modules with same name could share a same mapping

    TString fModuleUniqueName;  ///< The unique module name. i.e, M2, M0, V508
   ...
   public:
    ...
    /// Sets the unique name of the readout module
    void SetUniqueName(TString name) { fModuleUniqueName = name; }
    ...
    TString GetUniqueName() { return fModuleUniqueName; }
    ...
    void SetReadoutMapping(TRestReadoutMapping* mapping) { fMapping = mapping; }
    ...
    Bool_t isInsidePixelRelative(Int_t channel, Int_t pixel, Double_t x, Double_t y);
    Bool_t isInsidePixelRelative(Int_t channel, Int_t pixel, TVector2 pos);
